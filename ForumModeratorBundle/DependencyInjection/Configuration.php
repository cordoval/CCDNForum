...
namespace CCDNForum\ForumModeratorBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('ccdn_forum_forum_moderator');
			...
			->children()
				...
				->arrayNode('template')
					->children()
						...
						->scalarNode('theme')->defaultValue('CCDNForumForumModeratorBundle:Form:fields.html.twig')->end()
					->end()
				->end()
			->end();
